...
협업에서 지켜야 할 중요한 요소들을 인지하고, 지키려고 노력했습니다.

1. git commit message 컨벤션을 정해 commit이 어떤 내용인지 알기 쉽도록 했습니다.

2. 개인 작업 branch에서의 commit은 자주 하되, dev branch로의 merge 시 팀원의 확인 및 리뷰(PR) 후에 merge하도록 했습니다.

3. 팀원이 제 코드를 좀 더 쉽게 읽을 수 있도록 코드를 작성하려고 노력했고, 가독성의 중요성에 대해 다시 한 번 깨닫게 되었습니다.

4. 사소한 부분이라도 혼자 고민하는 것보다 팀원과 함께 고민하는 것이 훨씬 효율적이라는 것을 깨닫고, 오버 커뮤니케이션을 하려 노력했습니다.
