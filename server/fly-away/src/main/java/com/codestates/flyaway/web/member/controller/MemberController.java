...
public class MemberController {
    ...
    public UpdateResponse update(@NotNull @PathVariable Long memberId,
    ...
    public String getImage(@NotNull @PathVariable Long memberId) {
        return memberService.getImageUrl(memberId);
    }

    @ApiOperation(value = "회원 프로필 정보")
    @GetMapping("/{memberId}")
    public MemberProfileResponse findMember(@NotNull @PathVariable Long memberId) {
        return memberService.findByIdFetch(memberId);
    }

    @ApiOperation(value = "회원 탈퇴")
    @DeleteMapping("/{memberId}")
    public String delete(@NotNull @PathVariable Long memberId) {
